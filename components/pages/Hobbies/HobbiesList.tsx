...
export const hobbies = [
  ...
  {
    img: "/HobbiesPage/hobby-climbing.png",
    name: "Climbing",
    achievement: "7 UIAA",
    alt: "The author is belaying a climber",
  },
  {
    img: "/HobbiesPage/hobby-traveling.jpg",
    name: "Traveling",
    achievement: "EU, NA, SA, AS, AF",
    alt: "New York from the Hudson river",
  },
  {
    img: "/HobbiesPage/hobby-running.jpg",
    name: "Running",
